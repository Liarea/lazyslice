...
--
-- Name: search_index___3_npzyg_8sfiizc5jhpc; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.search_index___3_npzyg_8sfiizc5jhpc (
    id bigint NOT NULL,
...
--
-- Name: search_index___3_npzyg_8sfiizc5jhpc_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.search_index___3_npzyg_8sfiizc5jhpc ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.search_index___3_npzyg_8sfiizc5jhpc_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: search_index___3_npzyg_8sfiizc5jhpc search_index___3_npzyg_8sfiizc5jhpc_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.search_index___3_npzyg_8sfiizc5jhpc
    ADD CONSTRAINT search_index___3_npzyg_8sfiizc5jhpc_pkey PRIMARY KEY (id);
...
--
-- Name: search_index___3_npzyg_8sfiizc5jhpc_archived_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX search_index___3_npzyg_8sfiizc5jhpc_archived_idx ON public.search_index___3_npzyg_8sfiizc5jhpc USING btree (archived);


--
-- Name: search_index___3_npzyg_8sfiizc5jhpc_identity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX search_index___3_npzyg_8sfiizc5jhpc_identity_idx ON public.search_index___3_npzyg_8sfiizc5jhpc USING btree (model, model_id);


--
-- Name: search_index___3_npzyg_8sfiizc5jhpc_model_archived_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX search_index___3_npzyg_8sfiizc5jhpc_model_archived_idx ON public.search_index___3_npzyg_8sfiizc5jhpc USING btree (model, archived);


--
-- Name: search_index___3_npzyg_8sfiizc5jhpc_native_tsvector_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX search_index___3_npzyg_8sfiizc5jhpc_native_tsvector_idx ON public.search_index___3_npzyg_8sfiizc5jhpc USING gin (with_native_query_vector);


--
-- Name: search_index___3_npzyg_8sfiizc5jhpc_tsvector_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX search_index___3_npzyg_8sfiizc5jhpc_tsvector_idx ON public.search_index___3_npzyg_8sfiizc5jhpc USING gin (search_vector);
