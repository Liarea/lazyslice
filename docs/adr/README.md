...
| [017](017-a-first-run-at-a-terminal-asks-every-open-question.md) | A first run at a terminal asks every open question it has no shown default for (narrows ADR-008's one-question rule) | proposed 2026-09-24 |
