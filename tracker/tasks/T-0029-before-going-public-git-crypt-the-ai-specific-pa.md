...
- 2026-09-14 cancelled: the maintainer 2026-09-14: keep the AI-specific files public; nothing in them is a secret and encryption would cost tokens on every read and block contributors

## Post-mortem

Cancelled. Reason: the maintainer 2026-09-14: keep the AI-specific files public; nothing in them is a secret and encryption would cost tokens on every read and block contributors
